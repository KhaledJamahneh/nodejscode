  ...
  try {
    ...
    await transaction(async (client) => {
      ...
      if (latitude !== undefined) {
        profileUpdateFields.push(`latitude = $${paramCounter++}`);
        profileUpdateValues.push(latitude);
      }
      if (longitude !== undefined) {
        profileUpdateFields.push(`longitude = $${paramCounter++}`);
        profileUpdateValues.push(longitude);
      }
